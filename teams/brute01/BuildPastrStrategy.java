...
public class BuildPastrStrategy implements Strategy {
	...
	public void play() throws GameActionException {
		...
		//should set dest for pastr here.
		// loop through squares around HQ.
		// score  = negative for blocking hq? 
		// score-- for being out of range of HQ.?
		// score++ for being good distance from wall. 
